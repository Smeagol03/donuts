      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t-2 border-primary/10 p-4 z-50 shadow-2xl">
          <div className="flex gap-3 sm:gap-4">
            <Link
              href="/products"
              className="shrink-0 px-4 py-3 bg-surface-container text-on-surface rounded-xl font-semibold text-xs hover:bg-surface-high active:scale-95 transition-all flex items-center justify-center"
            >
              Tambah
            </Link>
            <Button 
